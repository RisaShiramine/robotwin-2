...
class stack_blocks_one(Base_Task):
    ...
    def load_actors(self):
        ...
        color_ids = np.random.permutation(len(color_options))[:2]
        ...
        self.block_color_names = [block_colors[0][1], block_colors[1][1]]

        self.blocks = [self.block1, self.block2]
        self.target_block_index = np.random.randint(0, 2)
    ...
    def check_success(self):
        ...
        return ((block1_on_center or block2_on_center)
